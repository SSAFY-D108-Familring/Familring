...
interface InterestRepository {
    ...
    suspend fun getInterestDetail(interestId: Long): Flow<ApiResponse<List<Profile>>>

    suspend fun createAnswer(answer: String): Flow<ApiResponse<Unit>>

    suspend fun getMyAnswer(): Flow<ApiResponse<String>>

    suspend fun updateAnswer(interestId: Long): Flow<ApiResponse<Unit>>

    suspend fun getAnswers(): Flow<ApiResponse<List<InterestCard>>>

    suspend fun getAnswerStatus(): Flow<ApiResponse<Boolean>>
